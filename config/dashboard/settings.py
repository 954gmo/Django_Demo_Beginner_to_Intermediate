...
config = f'config.dashboard.{CONFIGS[HOST]}'

setting_module_files = [
    'config.dashboard.base',  # setup base settings that are common to all profile, local, production or other env
    config,  # Automatically Determine which configuration file to setup with, by the hostname
    'config.dashboard.logging_conf',  # setup logging
    'config.dashboard.sitewide_conf',  # some site-wide ENV
]
